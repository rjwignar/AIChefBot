...
import { setCache, getCache, removeRecipeId } from "@/pages/api/sessionStorage";
    ...
    <>
      ...
      {generatePressed ? (
        ...
        <Container className="mt-5">
          ...
          {/* RecipeCardList for recipes generated by similar */}
          {/* Render recipes if available */}
          {generatedRecipes && (
            <RecipeCardList recipes={generatedRecipes} onDelete={removeRecipeId}/>
          )}
        </Container>
      ) : (
